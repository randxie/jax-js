...
declare namespace tokenizers_d_exports {
  export { BpeEncoding, BpeEncodingName, HuggingFaceBPE, Unigram, getBpe, loadHuggingFaceBpe, loadSentencePiece };
}
...
declare class HuggingFaceBPE {
  ...
  constructor(encoder: Map<string, number>, mergeRanks: Map<string, number>, specialTokens: Record<string, number>, regex: RegExp, normalizeNfc: boolean);
...
declare function loadHuggingFaceBpe(url: string | URL): Promise<HuggingFaceBPE>;
/**
...
declare function loadSentencePiece(url: string): Promise<Unigram>;
//#endregion
